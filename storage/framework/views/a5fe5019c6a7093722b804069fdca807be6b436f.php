<?php $__env->startSection('content'); ?>
  ...
  <body>
    <div class="container">
      ...
      <form method="post" action="<?php echo e(action('ClassesController@update', $id)); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="row">
          <div class="form-group col">
            ...
            <input type="text" class="form-control" name="classesname" value="<?php echo e($classes->class_name); ?>">
          </div>
          <div class="col"></div>
        </div>
